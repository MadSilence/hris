            ...
            <section className={styles.hero}>
                <div className={styles.heroInner}>
                    ...
                    <div className={styles.heroCtas}>
                        <Link href="/contact"><Button variant="primary">Request demo</Button></Link>
                        <Link href="/products"><Button variant="secondary">See products</Button></Link>
                    </div>
                </div>
            </section>
            ...
            <section className={styles.grid}>
                {[
                    ...
                    <Card key={f.title} className={styles.card}>
                        <h3>{f.title}</h3>
                        <p>{f.body}</p>
                        <Link href={f.link} className={styles.cardLink}>Learn more →</Link>
                    </Card>
                ))}
            </section>
            ...
            <section className={styles.gridTwo}>
                {[
                    ...
                    <Card key={s.title} className={styles.card}>
                        <h3>{s.title}</h3>
                        <p>{s.body}</p>
                        <Link href={s.link} className={styles.cardLink}>Explore →</Link>
                    </Card>
                ))}
            </section>
