...
export const ArchiveOfficeModal: React.FC<Props> = ({
  isOpen,
  isLoading = false,
  office,
  onConfirmAction,
  ...
  const count = office?.assignedUsersCount ?? 0;
        ...
        {count > 0 && (
          <div className="space-y-2">
            <p className="text-sm text-muted-foreground">
              {count} {count === 1 ? "person is" : "people are"} assigned to this office.
            </p>
            <StrategyOption
            ...
            <StrategyOption
              ...
              description="Remove this office from all assigned people. This can't be undone by restoring."
            />
          </div>
        )}
