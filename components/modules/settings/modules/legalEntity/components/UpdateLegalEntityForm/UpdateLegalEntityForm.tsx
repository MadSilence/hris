...
export type UpdateLegalEntityFormHandle = {
  submitForm: () => Promise<void>;
  isDirty: () => boolean;
  reset: () => void;
};

export interface UpdateLegalEntityFormProps {
  formRef?: RefObject<UpdateLegalEntityFormHandle | undefined>;
  onSubmit: (values: UpdateLegalEntityFormValues) => void | Promise<void>;
  initialValues: UpdateLegalEntityFormValues;
}

export const UpdateLegalEntityForm: React.FC<UpdateLegalEntityFormProps> = ({
  formRef,
  onSubmit,
  initialValues,
}) => {
  const handleFormSubmission = useCallback(
    (values: UpdateLegalEntityFormValues) => onSubmit(values),
    [onSubmit],
  );

  const formik = useFormik<UpdateLegalEntityFormValues>({
    initialValues,
